...
[condition][com.orangeleap.tangerine.domain.Person]There is a person=$person : Person($personId : id)
...
[condition][com.orangeleap.tangerine.domain.Person]- who is a lapsed donor=lapsedDonor == true
[condition][com.orangeleap.tangerine.domain.Gift]who just donated a gift=$gift : Gift(person.id == $personId, transactionDate == null)
...
[condition][com.orangeleap.tangerine.domain.Person]- who is a major donor=majorDonor == true
[condition][com.orangeleap.tangerine.domain.Person]- who is not a major donor=majorDonor == false
...
[condition][]who donated at least {number} gifts=$totalGifts : ArrayList(size >= 1) from collect (Gift(value > 0, person.id == $personId))
