...
INSERT INTO FIELD_REQUIRED (FIELD_REQUIRED_ID, SITE_NAME, SECTION_NAME, FIELD_DEFINITION_ID, SECONDARY_FIELD_DEFINITION_ID, REQUIRED) VALUES (20, 'company2', 'person.contactInfo', 'person.addressMap[primaryAddress]', 'address.postalCode', TRUE);

-- Add 5-digit validation to Zip Code on company2

INSERT INTO FIELD_VALIDATION (SITE_NAME, SECTION_NAME, FIELD_DEFINITION_ID, SECONDARY_FIELD_DEFINITION_ID, VALIDATION_REGEX) VALUES ('company2', 'person.contactInfo', 'person.addressMap[primaryAddress]', 'address.postalCode', '^\\d{5}$');
...
INSERT INTO MESSAGE_RESOURCE (LANGUAGE_ABBREVIATION, MESSAGE_KEY, MESSAGE_RESOURCE_TYPE, MESSAGE_VALUE, SITE_NAME) values ('en_US', 'fieldValidationFailure.person.addressMap[primaryAddress].postalCode', 'FIELD_VALIDATION', 'Zip code format should be in the format 00000-0000', 'company2');

-- Make Spouse Name a required field only when Marital Status = Married

INSERT INTO FIELD_REQUIRED (FIELD_REQUIRED_ID, SITE_NAME, SECTION_NAME, FIELD_DEFINITION_ID, REQUIRED) VALUES (21, null, 'person.contactInfo', 'person.spouseFirstName', TRUE);
