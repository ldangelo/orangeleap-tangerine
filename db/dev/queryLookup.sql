...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (11, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%employee%'' ', 'person.customFieldMap[employee.alternate]', 'person.alternate', null);
