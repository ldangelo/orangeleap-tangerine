...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (15, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%individual%'' ', 'person.customFieldMap[organization.accountManager]', 'person.accountManager', null);
...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (16, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%organization%'' ', 'person.customFieldMap[individual.accountManagerFor]', 'person.accountManagerFor', null);
INSERT INTO QUERY_LOOKUP_PARAM (PARAM_NAME, QUERY_LOOKUP_ID) VALUES ('organizationName', 16);

INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (17, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%individual%'' ', 'person.customFieldMap[organization.primaryContacts]', 'person.primaryContacts', null);
...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (18, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%organization%'' ', 'person.customFieldMap[individual.primaryContactFor]', 'person.primaryContactFor', null);
INSERT INTO QUERY_LOOKUP_PARAM (PARAM_NAME, QUERY_LOOKUP_ID) VALUES ('organizationName', 18);

INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (19, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%individual%'' ', 'person.customFieldMap[organization.billingContacts]', 'person.billingContacts', null);
...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (20, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%organization%'' ', 'person.customFieldMap[individual.billingContactFor]', 'person.billingContactFor', null);
INSERT INTO QUERY_LOOKUP_PARAM (PARAM_NAME, QUERY_LOOKUP_ID) VALUES ('organizationName', 20);

INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (21, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%individual%'' ', 'person.customFieldMap[organization.salesContacts]', 'person.salesContacts', null);
...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (22, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%organization%'' ', 'person.customFieldMap[individual.salesContactFor]', 'person.salesContactFor', null);
INSERT INTO QUERY_LOOKUP_PARAM (PARAM_NAME, QUERY_LOOKUP_ID) VALUES ('organizationName', 22);

INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (23, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%individual%'' ', 'person.customFieldMap[organization.publicRelationsContacts]', 'person.publicRelationsContacts', null);
...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, JPA_QUERY, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (24, 'SELECT person FROM com.mpower.domain.Person person WHERE person.site.id = :siteName AND person.constituentAttributes like ''%organization%'' ', 'person.customFieldMap[individual.publicRelationsContactFor]', 'person.publicRelationsContactFor', null);
