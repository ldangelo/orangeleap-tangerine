...
INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, FIELD_TYPE) VALUES ('selectedEmail.customFieldMap[emailTypeReadOnly]', 'selectedEmail', 'customFieldMap[emailType]', 'Email Type', 'MULTI_PICKLIST_DISPLAY');
