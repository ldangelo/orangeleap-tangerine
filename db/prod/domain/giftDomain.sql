...
INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES ('gift.checkAccountNumber', 'gift', 'checkAccountNumber', 'Account Number', '', 'ENCRYPTED');
INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES ('gift.checkAccountNumberReadOnly', 'gift', 'checkAccountNumber', 'Account Number', '', 'ENCRYPTED_DISPLAY');
INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES ('gift.checkRoutingNumber', 'gift', 'checkRoutingNumber', 'Routing Number', '', 'TEXT');
INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES ('gift.checkRoutingNumberReadOnly', 'gift', 'checkRoutingNumber', 'Routing Number', '', 'READ_ONLY_TEXT');
