...
// Gift reference
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, ENTITY_TYPE, SQL_WHERE, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (1000025, 'constituent','constituent_type = ''individual'' ', 'gift.customFieldMap[reference]', 'gift.donation', null);
...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, ENTITY_TYPE, SQL_WHERE, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (1000030, 'constituent','constituent_type = ''individual'' ', 'gift.customFieldMap[tributeReference]', 'gift.tributeReference', null);
...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, ENTITY_TYPE, SQL_WHERE, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (1000031, 'constituent','constituent_type = ''individual'' ', 'gift.customFieldMap[onBehalfOf]', 'gift.onBehalfOf', null);
...
INSERT INTO QUERY_LOOKUP (QUERY_LOOKUP_ID, ENTITY_TYPE, SQL_WHERE, FIELD_DEFINITION_ID, SECTION_NAME, SITE_NAME) VALUES (1000032, 'constituent','constituent_type = ''individual'' ', 'gift.customFieldMap[notified]', 'gift.notified', null);
