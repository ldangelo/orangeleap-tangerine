...
INSERT INTO RULE_EVENT_TYPE (RULE_EVENT_TYPE_ID, RULE_EVENT_TYPE_NAME_ID, RULE_EVENT_TYPE_DESC) VALUES (6,'scheduled-daily', 'Scheduled Daily');
INSERT INTO RULE_EVENT_TYPE (RULE_EVENT_TYPE_ID, RULE_EVENT_TYPE_NAME_ID, RULE_EVENT_TYPE_DESC) VALUES (7,'scheduled-weekly', 'Scheduled Weekly');
INSERT INTO RULE_EVENT_TYPE (RULE_EVENT_TYPE_ID, RULE_EVENT_TYPE_NAME_ID, RULE_EVENT_TYPE_DESC) VALUES (8,'scheduled-monthly', 'Scheduled Monthly');
...
SET @PHRASE_CD = 'Constituent has a numeric custom field named ? that ? ?';
...
-- --------------------------------------------------------------------------------------------------------------------------------
SET @PHRASE_CD = 'Constituent has a date custom field named ? that ? ?';
...
-- --------------------------------------------------------------------------------------------------------------------------------
SET @PHRASE_CD = 'Constituent has a date custom field named ? whose age ? ?';
...
-- --------------------------------------------------------------------------------------------------------------------------------
SET @PHRASE_CD = 'Constituent has donated at least ? dollars over the past ? ?';
SET @CODE_CD = 'BigDecimal.valueOf(?.doubleValue()) <= map.ruleHelperService.totalDonationsPerTimeFrame(map.constituent, ?.intValue(), ? )';
