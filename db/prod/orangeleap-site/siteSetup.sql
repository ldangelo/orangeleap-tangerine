...
INSERT INTO SITE_OPTION (SITE_NAME, OPTION_NAME, OPTION_NAME_READ_ONLY, OPTION_DESC, OPTION_VALUE, OPTION_VALUE_READ_ONLY, MODIFIED_BY, CREATE_DATE, UPDATE_DATE) VALUES (DATABASE(), 'firsttimedonorsubject', 0, 'The subject line for the email.', 'Thank you for your 1st time donation', 0, 1, NOW(), null);
INSERT INTO SITE_OPTION (SITE_NAME, OPTION_NAME, OPTION_NAME_READ_ONLY, OPTION_DESC, OPTION_VALUE, OPTION_VALUE_READ_ONLY, MODIFIED_BY, CREATE_DATE, UPDATE_DATE) VALUES (DATABASE(), 'firsttimedonortemplate', 0, 'The name of the template in the guru.', 'thankYou', 0, 1, NOW(), null);
