...
INSERT INTO PICKLIST_ITEM (PICKLIST_ID, ITEM_NAME, DEFAULT_DISPLAY_VALUE, REFERENCE_VALUE, ITEM_ORDER) VALUES (1000019, 'Credit Card', 'Credit Card', '.gift_creditCard,li:has(#paymentSource-tangDot-id),#creditCard-paymentSource-tangDot-id', 1);
INSERT INTO PICKLIST_ITEM (PICKLIST_ID, ITEM_NAME, DEFAULT_DISPLAY_VALUE, REFERENCE_VALUE, ITEM_ORDER) VALUES (1000019, 'ACH', 'ACH', '.gift_ach,li:has(#paymentSource-tangDot-id),#ach-paymentSource-tangDot-id', 2);
