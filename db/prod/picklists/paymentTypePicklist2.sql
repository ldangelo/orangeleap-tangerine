...
INSERT INTO PICKLIST_ITEM (PICKLIST_ID, ITEM_NAME, DEFAULT_DISPLAY_VALUE, REFERENCE_VALUE, ITEM_ORDER) VALUES (1000019, 'Credit Card', 'Credit Card', 'li:has(#paymentSource-tangDot-id)', 1);
INSERT INTO PICKLIST_ITEM (PICKLIST_ID, ITEM_NAME, DEFAULT_DISPLAY_VALUE, REFERENCE_VALUE, ITEM_ORDER) VALUES (1000019, 'ACH', 'ACH', 'li:has(#paymentSource-tangDot-id)', 2);
