...
INSERT INTO RULE_SEGMENT_TYPE (RULE_SEGMENT_TYPE_ID, RULE_SEGMENT_TYPE_TYPE, RULE_SEGMENT_TYPE_TEXT) VALUES (1,'condition','true');
INSERT INTO RULE_SEGMENT_TYPE (RULE_SEGMENT_TYPE_ID, RULE_SEGMENT_TYPE_TYPE, RULE_SEGMENT_TYPE_TEXT) VALUES (2,'consequence','println "hello"');


INSERT INTO RULE (RULE_ID,RULE_EVENT_TYPE_NAME_ID,RULE_SEQ,RULE_DESC,RULE_IS_ACTIVE,SITE_NAME) VALUES (1,'gift-save',0,'A Test Rule','Y','company1');
