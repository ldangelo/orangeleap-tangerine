...
KEY `FK_ENT_DEF_SEC_DEF` (`SECTION_DEFINITION_ID`),
KEY `FK_ENT_DEF_SITE` (`SITE_NAME`),
CONSTRAINT `FK_ENT_DEF_SEC_DEF` FOREIGN KEY (`SECTION_DEFINITION_ID`) REFERENCES `SECTION_DEFINITION` (`SECTION_DEFINITION_ID`),
...
-- currently commented out for tests
