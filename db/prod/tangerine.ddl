...
CREATE TABLE `DISTRO_LINE` (
  ...
  KEY `FK_DISTRO_LINE_ADJUSTED_GIFT` (`ADJUSTED_GIFT_ID`),
  ...
  CONSTRAINT `FK_DISTRO_LINE_ADJUSTED_GIFT` FOREIGN KEY (`ADJUSTED_GIFT_ID`) REFERENCES `ADJUSTED_GIFT` (`ADJUSTED_GIFT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
