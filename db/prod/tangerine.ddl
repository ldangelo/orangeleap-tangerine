...
# Dump of table POST_BATCH_SEGMENTATION
# ------------------------------------------------------------

DROP TABLE IF EXISTS `POST_BATCH_SEGMENTATION`;

CREATE TABLE `POST_BATCH_SEGMENTATION` (
`POST_BATCH_SEGMENTATION_ID` bigint(20) NOT NULL auto_increment,
`POST_BATCH_ID` bigint(20) NOT NULL,
`SEGMENTATION_ID` bigint(20) NOT NULL,
`CREATE_DATE` datetime default NULL,
`UPDATE_DATE` datetime default NULL,
PRIMARY KEY  (`POST_BATCH_SEGMENTATION_ID`),
CONSTRAINT `FK_POST_BATCH_SEGMENTATION_BATCH_ID` FOREIGN KEY (`POST_BATCH_ID`) REFERENCES `POST_BATCH` (`POST_BATCH_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
