...
# ------------------------------------------------------------
# Note: Can only reference site-specific FIELD_RELATIONSHIP records (SITE_NAME is not NULL)
...
--  `FIELD_RELATIONSHIP_ID` bigint(20) NOT NULL, 
--  PRIMARY KEY  (`CUSTOM_FIELD_RELATIONSHIP_ID`),
--  CONSTRAINT `FK_CFR_FIELD_RELATIONSHIP` FOREIGN KEY (`FIELD_RELATIONSHIP_ID`) REFERENCES `FIELD_RELATIONSHIP` (`FIELD_RELATIONSHIP_ID`)
--) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--  CONSTRAINT `FK_CCR_FIELD_RELATIONSHIP` FOREIGN KEY (`FIELD_RELATIONSHIP_ID`) REFERENCES `FIELD_RELATIONSHIP` (`FIELD_RELATIONSHIP_ID`)
--) ENGINE=InnoDB DEFAULT CHARSET=latin1;
