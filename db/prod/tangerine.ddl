...
CREATE UNIQUE INDEX idx_constituent_custom_id ON CONSTITUENT(SITE_NAME,CUSTOM_ID);
...
CREATE TABLE `COMMITMENT` (
  ...
  KEY `FK_COMMITMENT_CONSTITUENT` (`CONSTITUENT_ID`),
  ...
  CONSTRAINT `FK_COMMITMENT_CONSTITUENT` FOREIGN KEY (`CONSTITUENT_ID`) REFERENCES `CONSTITUENT` (`CONSTITUENT_ID`),
