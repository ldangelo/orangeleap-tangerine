...
UPDATE `SECTION_FIELD` SET FIELD_DEFINITION_ID='paymentSource.address.shortAddressReadOnly' ,SECONDARY_FIELD_DEFINITION_ID='address.shortDisplay' WHERE (`SECTION_DEFINITION_ID` = (SELECT SECTION_DEFINITION_ID FROM SECTION_DEFINITION WHERE SECTION_NAME='paymentSourceList.resultsInfo' AND PAGE_TYPE='paymentSourceList') AND `FIELD_DEFINITION_ID` = 'paymentSource.selectedAddress.shortAddressReadOnly' AND `SECONDARY_FIELD_DEFINITION_ID` = 'selectedAddress.shortDisplay');
UPDATE `SECTION_FIELD` SET FIELD_DEFINITION_ID='paymentSource.phone.numberReadOnly' ,SECONDARY_FIELD_DEFINITION_ID= 'phone.numberReadOnly' WHERE (`SECTION_DEFINITION_ID` = (SELECT SECTION_DEFINITION_ID FROM SECTION_DEFINITION WHERE SECTION_NAME='paymentSourceList.resultsInfo' AND PAGE_TYPE='paymentSourceList') AND `FIELD_DEFINITION_ID` = 'paymentSource.selectedPhone.numberReadOnly' AND `SECONDARY_FIELD_DEFINITION_ID` = 'selectedPhone.numberReadOnly');
...
INSERT INTO `SECTION_FIELD` (FIELD_ORDER,FIELD_DEFINITION_ID,SECONDARY_FIELD_DEFINITION_ID,SECTION_DEFINITION_ID,SITE_NAME) SELECT '3500', 'paymentHistory.paymentStatus', NULL, SECTION_DEFINITION_ID,NULL FROM SECTION_DEFINITION WHERE SECTION_NAME='paymentHistoryList.resultsInfo' AND PAGE_TYPE='paymentHistoryList';
...
UPDATE `SECTION_FIELD` SET `FIELD_ORDER`='3000'  WHERE (`SECTION_DEFINITION_ID` = (SELECT SECTION_DEFINITION_ID FROM SECTION_DEFINITION WHERE SECTION_NAME='communicationHistoryList.resultsInfo' AND PAGE_TYPE='communicationHistoryList') AND `FIELD_DEFINITION_ID` = 'communicationHistory.entryType' AND `SECONDARY_FIELD_DEFINITION_ID` IS NULL) ;

UPDATE `SECTION_FIELD` SET `FIELD_ORDER`='2000'  WHERE (`SECTION_DEFINITION_ID` = (SELECT SECTION_DEFINITION_ID FROM SECTION_DEFINITION WHERE SECTION_NAME='communicationHistoryList.resultsInfo' AND PAGE_TYPE='communicationHistoryList') AND `FIELD_DEFINITION_ID` = 'communicationHistory.recordDate' AND `SECONDARY_FIELD_DEFINITION_ID` IS NULL) ;
