...
UPDATE `PAGE_ACCESS` SET `PAGE_ACCESS_ID`='1000001', `ACCESS_TYPE`='ALLOWED', `PAGE_TYPE`='picklistItems', `ROLE`='ROLE_SUPER_USER', `SITE_NAME`=NULL  WHERE (`PAGE_ACCESS_ID` = 1000001) ;
UPDATE `PAGE_ACCESS` SET `PAGE_ACCESS_ID`='1000008', `ACCESS_TYPE`='ALLOWED', `PAGE_TYPE`='postbatch', `ROLE`='ROLE_ADMIN', `SITE_NAME`=NULL  WHERE (`PAGE_ACCESS_ID` = 1000008) ;
UPDATE `PAGE_ACCESS` SET `PAGE_ACCESS_ID`='1000003', `ACCESS_TYPE`='ALLOWED', `PAGE_TYPE`='siteAudit', `ROLE`='ROLE_ADMIN', `SITE_NAME`=NULL  WHERE (`PAGE_ACCESS_ID` = 1000003) ;
UPDATE `PAGE_ACCESS` SET `PAGE_ACCESS_ID`='1000004', `ACCESS_TYPE`='ALLOWED', `PAGE_TYPE`='audit', `ROLE`='ROLE_ADMIN', `SITE_NAME`=NULL  WHERE (`PAGE_ACCESS_ID` = 1000004) ;
UPDATE `PAGE_ACCESS` SET `PAGE_ACCESS_ID`='1000000', `ACCESS_TYPE`='ALLOWED', `PAGE_TYPE`='importexport', `ROLE`='ROLE_ADMIN', `SITE_NAME`=NULL  WHERE (`PAGE_ACCESS_ID` = 1000000) ;
