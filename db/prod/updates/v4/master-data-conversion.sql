...
UPDATE `PAGE_ACCESS` SET `ROLE`='ROLE_SUPER_USER'  WHERE (`PAGE_ACCESS_ID` = 1000001) ;
UPDATE `PAGE_ACCESS` SET `ROLE`='ROLE_ADMIN'  WHERE (`PAGE_ACCESS_ID` = 1000008) ;
UPDATE `PAGE_ACCESS` SET `ROLE`='ROLE_ADMIN'  WHERE (`PAGE_ACCESS_ID` = 1000003) ;
UPDATE `PAGE_ACCESS` SET `ROLE`='ROLE_ADMIN'  WHERE (`PAGE_ACCESS_ID` = 1000004) ;
UPDATE `PAGE_ACCESS` SET `ROLE`='ROLE_ADMIN'  WHERE (`PAGE_ACCESS_ID` = 1000000) ;
