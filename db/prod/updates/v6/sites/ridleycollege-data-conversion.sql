...
SELECT SECTION_DEFINITION_ID, 'ridleycollege-gift.customFieldMap[OtherPayMethodReadOnly]', 1200, 'ridleycollege' FROM SECTION_DEFINITION WHERE SECTION_NAME='gift.payment' AND PAGE_TYPE='giftPaid';
