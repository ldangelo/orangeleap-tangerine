...
INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES
('gift.checkAccountNumberReadOnly', 'gift', 'checkAccountNumber', 'Account Number', '', 'READ_ONLY_TEXT');

INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES
('gift.checkRoutingNumber', 'gift', 'checkRoutingNumber', 'Routing Number', '', 'TEXT');

INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES
('gift.checkRoutingNumberReadOnly', 'gift', 'checkRoutingNumber', 'Routing Number', '', 'READ_ONLY_TEXT');
...
INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES 
('adjustedGift.checkAccountNumberReadOnly', 'adjustedGift', 'checkAccountNumber', 'Account Number', '', 'READ_ONLY_TEXT');

INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES
('adjustedGift.checkRoutingNumber', 'adjustedGift', 'checkRoutingNumber', 'Routing Number', '', 'TEXT');

INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, ENTITY_ATTRIBUTES, FIELD_TYPE) VALUES
('adjustedGift.checkRoutingNumberReadOnly', 'adjustedGift', 'checkRoutingNumber', 'Routing Number', '', 'READ_ONLY_TEXT');



INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'gift.checkRoutingNumber', 3000 FROM SECTION_DEFINITION WHERE SECTION_NAME='gift.check' AND PAGE_TYPE='gift';

INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'gift.checkRoutingNumber', 3000 FROM SECTION_DEFINITION WHERE SECTION_NAME='gift.check' AND PAGE_TYPE='giftPaid';

INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'gift.checkRoutingNumberReadOnly', 3000 FROM SECTION_DEFINITION WHERE SECTION_NAME='gift.check' AND PAGE_TYPE='giftPosted';



INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'gift.checkAccountNumber', 4000 FROM SECTION_DEFINITION WHERE SECTION_NAME='gift.check' AND PAGE_TYPE='gift';

INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'gift.checkAccountNumber', 4000 FROM SECTION_DEFINITION WHERE SECTION_NAME='gift.check' AND PAGE_TYPE='giftPaid';

INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'gift.checkAccountNumberReadOnly', 4000 FROM SECTION_DEFINITION WHERE SECTION_NAME='gift.check' AND PAGE_TYPE='giftPosted';



INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'adjustedGift.checkRoutingNumber', 3000 FROM SECTION_DEFINITION WHERE SECTION_NAME='adjustedGift.check' AND PAGE_TYPE='adjustedGift';

INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'adjustedGift.checkRoutingNumber', 3000 FROM SECTION_DEFINITION WHERE SECTION_NAME='adjustedGift.check' AND PAGE_TYPE='adjustedGiftPaid';

INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'adjustedGift.checkRoutingNumberReadOnly', 3000 FROM SECTION_DEFINITION WHERE SECTION_NAME='adjustedGift.check' AND PAGE_TYPE='adjustedGiftPosted';



INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'adjustedGift.checkAccountNumber', 4000 FROM SECTION_DEFINITION WHERE SECTION_NAME='adjustedGift.check' AND PAGE_TYPE='adjustedGift';

INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'adjustedGift.checkAccountNumber', 4000 FROM SECTION_DEFINITION WHERE SECTION_NAME='adjustedGift.check' AND PAGE_TYPE='adjustedGiftPaid';

INSERT INTO SECTION_FIELD (SECTION_DEFINITION_ID, FIELD_DEFINITION_ID, FIELD_ORDER)
SELECT SECTION_DEFINITION_ID, 'adjustedGift.checkAccountNumberReadOnly', 4000 FROM SECTION_DEFINITION WHERE SECTION_NAME='adjustedGift.check' AND PAGE_TYPE='adjustedGiftPosted';
