...
ALTER TABLE CUSTOM_FIELD 
	DROP INDEX CUSTOM_FIELD_ENTITY_IDX;
	
ALTER TABLE CUSTOM_FIELD 
	DROP INDEX IDX_CUSTOM_FIELD_FIELD_VALUE;
	
ALTER TABLE CUSTOM_FIELD 
    ADD INDEX `CUSTOM_FIELD_ENTITY_IDX` (`ENTITY_ID`,`ENTITY_TYPE`,`FIELD_NAME`);

ALTER TABLE CUSTOM_FIELD 
    ADD INDEX `IDX_CUSTOM_FIELD_FIELD_VALUE` (`ENTITY_TYPE`,`FIELD_NAME`,`FIELD_VALUE`(10));
...
ALTER TABLE GIFT 
	ADD KEY `KEY_GIFT_AMOUNT` (`AMOUNT`);
...
ALTER TABLE CONSTITUENT
    ADD KEY IDX_CONSTITUENT_ORGANIZATION_NAME (`ORGANIZATION_NAME`);

ALTER TABLE CONSTITUENT
    ADD KEY `IDX_CONSTITUENT_UPDATE_DATE` (`UPDATE_DATE`);

ALTER TABLE COMMUNICATION_HISTORY
    ADD KEY `IDX_COMMUNICATION_HISTORY_BATCH_ID` (`BATCH_ID`);

ALTER TABLE COMMUNICATION_HISTORY
    ADD KEY `IDX_COMMUNICATION_ADJ_GIFT_ID` (`ADJUSTED_GIFT_ID`);
...
ALTER TABLE COMMUNICATION_HISTORY
	...
	ADD COLUMN (`BATCH_ID` bigint(20) default NULL);
...
/* TANGERINE-936 */
ALTER TABLE RECURRING_GIFT
ADD COLUMN (`RECURRING_GIFT_CANCEL_DATE` datetime default NULL),
ADD COLUMN (`RECURRING_GIFT_CANCEL_REASON` varchar(255) default NULL);
