...
SET @CODE_CD = 'map.ruleHelperService.sendMail(map.constituent,map.gift,?,null,?,false);';
...
-- --------------------------------------------------------------------------------------------------------------------------------
SET @PHRASE_CD = 'Send email to constituent(primary email only) with subject of ? and using template ?';
SET @CODE_CD = 'map.ruleHelperService.sendMail(map.constituent,map.gift,?,null,?,true);';
...
SET @CODE_CD = 'map.ruleHelperService.sendMail(?,map.constituent,map.gift,?,null,?,null);';
