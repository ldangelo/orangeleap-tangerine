...
TRUNCATE TABLE RULE;
TRUNCATE TABLE RULE_EVENT_TYPE;
TRUNCATE TABLE RULE_EVENT_TYPE_X_RULE_SEGMENT_TYPE;
TRUNCATE TABLE RULE_GENERATED_CODE;
TRUNCATE TABLE RULE_SEGMENT;
TRUNCATE TABLE RULE_SEGMENT_PARM;
TRUNCATE TABLE RULE_SEGMENT_TYPE;
TRUNCATE TABLE RULE_SEGMENT_TYPE_PARM;
TRUNCATE TABLE RULE_VERSION;
...
-- --------------------------------------------------------------------------------------------------------------------------------
SET @PHRASE_CD = 'Constituent has a profile type of ?';
SET @CODE_CD = 'map.ruleHelperService.hasProfileType(map.constituent, ?)';
...
-- --------------------------------------------------------------------------------------------------------------------------------
SET @PHRASE_CD = 'Constituent does not have a profile type of ?';
SET @CODE_CD = '!map.ruleHelperService.hasProfileType(map.constituent, ?)';
...
SET @CODE_CD = 'map.ruleHelperService.hasDonorProfile(map.constituent, ?)';
...
-- --------------------------------------------------------------------------------------------------------------------------------
SET @PHRASE_CD = 'Set the profile type to ?';
SET @CODE_CD = 'map.ruleHelperService.addProfileType(map.constituent, ?);';
...
-- --------------------------------------------------------------------------------------------------------------------------------
SET @PHRASE_CD = 'Remove the profile type of ?';
SET @CODE_CD = 'map.ruleHelperService.removeProfileType(map.constituent, ?);';
...
-- --------------------------------------------------------------------------------------------------------------------------------
SET @PHRASE_CD = 'Set donor profile to ?';
SET @CODE_CD = 'map.ruleHelperService.addDonorProfile(map.constituent, ?);';
...
SET @CODE_CD = 'map.ruleHelperService.removeDonorProfile(map.constituent, ?);';
