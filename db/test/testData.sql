...
insert into COMMUNICATION_HISTORY (COMMUNICATION_HISTORY_ID, COMMUNICATION_TYPE, CREATE_DATE, RECORD_DATE, SYSTEM_GENERATED, UPDATE_DATE, COMMITMENT_ID, PERSON_ID, COMMENTS)
values (100, 'GIFT_RECEIPT', now(), '2009-01-01 08:00:00', false, now(), 100, 100, 'hello there');
insert into COMMUNICATION_HISTORY (COMMUNICATION_HISTORY_ID, COMMUNICATION_TYPE, CREATE_DATE, RECORD_DATE, SYSTEM_GENERATED, UPDATE_DATE, GIFT_ID, PERSON_ID)
