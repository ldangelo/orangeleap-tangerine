...
INSERT INTO FIELD_DEFINITION (FIELD_DEFINITION_ID, ENTITY_TYPE, FIELD_NAME, DEFAULT_LABEL, FIELD_TYPE) VALUES ('communicationHistory.customFieldMap[rank]', 'communicationHistory', 'customFieldMap[rank]', 'Rank', 'NUMBER');
...
INSERT INTO CONSTITUENT (CONSTITUENT_ID, ACCOUNT_NUMBER, CONSTITUENT_TYPE, TITLE, FIRST_NAME, MIDDLE_NAME, LAST_NAME, SUFFIX, MARITAL_STATUS, ORGANIZATION_NAME, SITE_NAME, CREATE_DATE, UPDATE_DATE, RECOGNITION_NAME) VALUES (300, 3000000, 'individual', 'Mr.', 'Howdy', null, 'Doody', null, 'Single', 'Howdy Doody Inc', 'company1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Mr. Howdy Doody');

-- Custom Fields
INSERT INTO `CUSTOM_FIELD` (`FIELD_NAME`,`FIELD_VALUE`,`FIELD_NUMERIC_VALUE`,`ENTITY_TYPE`,`ENTITY_ID`,`SEQUENCE_NUM`,`START_DATE`,`END_DATE`)
VALUES
	('onBehalfOf', '100', 100, 'distributionline', 100, 0, '1900-01-01 00:00:00', '3000-01-01 00:00:00');
INSERT INTO `CUSTOM_FIELD` (`FIELD_NAME`,`FIELD_VALUE`,`FIELD_NUMERIC_VALUE`,`ENTITY_TYPE`,`ENTITY_ID`,`SEQUENCE_NUM`,`START_DATE`,`END_DATE`)
VALUES
	('onBehalfOf', '100', 100, 'distributionline', 200, 0, '1900-01-01 00:00:00', '3000-01-01 00:00:00');
INSERT INTO `CUSTOM_FIELD` (`FIELD_NAME`,`FIELD_VALUE`,`FIELD_NUMERIC_VALUE`,`ENTITY_TYPE`,`ENTITY_ID`,`SEQUENCE_NUM`,`START_DATE`,`END_DATE`)
VALUES
	('onBehalfOf', '300', 300, 'distributionline', 200, 0, '1900-01-01 00:00:00', '3000-01-01 00:00:00');
INSERT INTO `CUSTOM_FIELD` (`FIELD_NAME`,`FIELD_VALUE`,`FIELD_NUMERIC_VALUE`,`ENTITY_TYPE`,`ENTITY_ID`,`SEQUENCE_NUM`,`START_DATE`,`END_DATE`)
VALUES
	('onBehalfOf', '100', 100, 'distributionline', 5001, 0, '1900-01-01 00:00:00', '3000-01-01 00:00:00');
INSERT INTO `CUSTOM_FIELD` (`FIELD_NAME`,`FIELD_VALUE`,`FIELD_NUMERIC_VALUE`,`ENTITY_TYPE`,`ENTITY_ID`,`SEQUENCE_NUM`,`START_DATE`,`END_DATE`)
VALUES
	('onBehalfOf', '200', 200, 'distributionline', 5002, 0, '1900-01-01 00:00:00', '3000-01-01 00:00:00');
...
INSERT INTO EMAIL (EMAIL_ID, EMAIL_ADDRESS, CREATE_DATE, UPDATE_DATE, CONSTITUENT_ID, RECEIVE_CORRESPONDENCE, ACTIVATION_STATUS, INACTIVE, IS_PRIMARY) VALUES (500, 'dude@dude.com', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 300, false, 'permanent', false, true);
...
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID, POSTED, POSTED_DATE) VALUES (5000, 'MONETARY_GIFT', 35, 'Cash', 300, 1, now());
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID) VALUES (5001, 'MONETARY_GIFT', 25, 'Check', 300);
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID) VALUES (5002, 'MONETARY_GIFT', 15, 'Cash', 300);
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID, POSTED, POSTED_DATE) VALUES (5003, 'MONETARY_GIFT', 5, 'Cash', 300, 1, now());

INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID, POSTED, POSTED_DATE) VALUES (6000, 'MONETARY_GIFT', 35, 'Cash', 300, 1, now());
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID) VALUES (6001, 'MONETARY_GIFT', 25, 'Check', 300);
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID) VALUES (6002, 'MONETARY_GIFT', 15, 'Cash', 300);
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID, POSTED, POSTED_DATE) VALUES (6003, 'MONETARY_GIFT', 5, 'Cash', 300, 1, now());

INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID, POSTED, POSTED_DATE) VALUES (7000, 'MONETARY_GIFT', 35, 'Cash', 300, 1, now());
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID) VALUES (7001, 'MONETARY_GIFT', 25, 'Check', 300);

INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID, POSTED, POSTED_DATE) VALUES (8000, 'MONETARY_GIFT', 35, 'Cash', 300, 1, now());
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID) VALUES (8001, 'MONETARY_GIFT', 25, 'Check', 300);

INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID, POSTED, POSTED_DATE) VALUES (9000, 'MONETARY_GIFT', 35, 'Cash', 300, 1, now());
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID) VALUES (9001, 'MONETARY_GIFT', 25, 'Check', 300);

INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID, POSTED, POSTED_DATE) VALUES (10000, 'MONETARY_GIFT', 35, 'Cash', 300, 1, now());
INSERT INTO GIFT (GIFT_ID, GIFT_TYPE, AMOUNT, PAYMENT_TYPE, CONSTITUENT_ID) VALUES (10001, 'MONETARY_GIFT', 25, 'Check', 300);
...
insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID)	values (5001, 25, 100, '01000', 5001);
insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID) values (5002, 15, 100, '01000', 5002);

insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID)	values (6001, 25, 100, '01000', 6001);
insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID) values (6002, 15, 100, '01000', 6002);

insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID)	values (7000, 25, 100, '01000', 7000);
insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID) values (7001, 15, 100, '01000', 7001);

insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID)	values (8000, 25, 100, '01000', 8000);
insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID) values (8001, 15, 100, '01000', 8001);

insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID)	values (9000, 25, 100, '01000', 9000);
insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID) values (9001, 15, 100, '01000', 9001);

insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID)	values (10000, 25, 100, '01000', 10000);
insert into DISTRO_LINE (DISTRO_LINE_ID, AMOUNT, PERCENTAGE, PROJECT_CODE, GIFT_ID) values (10001, 15, 100, '01000', 10001);
...
insert into POST_BATCH (POST_BATCH_ID, POST_BATCH_DESC, ENTITY, EXECUTED, BATCH_CREATED_BY_ID, BATCH_CREATED_DATE, SITE_NAME, CREATE_DATE, UPDATE_DATE, IS_ERROR_BATCH)
values (2, 'Batch 2', 'gift', 0, 100, now(), 'company1', now(), now(), 1);
...
insert into POST_BATCH (POST_BATCH_ID, POST_BATCH_DESC, ENTITY, EXECUTED, BATCH_CREATED_BY_ID, BATCH_CREATED_DATE, SITE_NAME, CREATE_DATE, UPDATE_DATE, IS_ERROR_BATCH)
values (4, 'Batch 4', 'gift', 0, 100, now(), 'company1', now(), now(), 0);

-- Post Batch Entries
insert into POST_BATCH_ENTRY (POST_BATCH_ID, SEGMENTATION_ID, CREATE_DATE, UPDATE_DATE)
