...
insert into POST_BATCH (POST_BATCH_ID, POST_BATCH_DESC, ENTITY, EXECUTED, BATCH_CREATED_BY_ID, BATCH_CREATED_DATE, SITE_NAME, CREATE_DATE, UPDATE_DATE, HAS_ERRORS)
