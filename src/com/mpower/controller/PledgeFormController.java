...
public class PledgeFormController extends SimpleFormController {
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
        ...
        if (commitmentId == null) {
            ...
            if (personId != null) {
                ...
                commitment = commitmentService.createDefaultCommitment(person, CommitmentType.PLEDGE);
    ...
    public ModelAndView onSubmit(Object command, BindException errors) throws ServletException {
        ...
        ModelAndView mav = new ModelAndView("redirect:/pledgeView.htm", errors.getModel());
