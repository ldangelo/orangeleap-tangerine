...
public class RecurringGiftFormController extends SimpleFormController {
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
        ...
        if (commitmentId == null) {
            ...
            if (personId != null) {
                ...
                commitment = commitmentService.createDefaultCommitment(person, CommitmentType.RECURRING_GIFT);
