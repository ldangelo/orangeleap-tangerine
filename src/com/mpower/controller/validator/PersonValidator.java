...
public class PersonValidator implements Validator {
	...
	public PageCustomizationService getPageCustomizationService() {
		return pageCustomizationService;
	}

	public void setPageCustomizationService(
			PageCustomizationService pageCustomizationService) {
