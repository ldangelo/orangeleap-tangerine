...
public class CustomFieldController extends SimpleFormController {
    ...
    public ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws Exception {
        ...
        try {
            ...
            if (StringUtils.trimToNull(customFieldRequest.getEntityType()) == null)
                throw new RuntimeException("Entity type required.");
            if (!customFieldRequest.getFieldName().matches("^[a-z][a-z0-9]*$"))
                throw new RuntimeException("Invalid field name.");
            if (StringUtils.trimToNull(customFieldRequest.getLabel()) == null)
            ...
            if (errormessage.contains("Duplicate entry"))
                errormessage = "Custom Field name is a duplicate of an existing one.";
