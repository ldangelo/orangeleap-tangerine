...
/**
 * Segmentation information from the Guru - includes name, description, count, etc
 */
public class Segmentation implements Serializable {
    ...
    public Segmentation(Long id, String name, String description, long count,
                        Date lastRunDate, String lastRunByUser) {
        this.id = id;
        this.name = name;
