...
@Controller
public class RecurringGiftListController extends TangerineJsonListController {
    ...
    public ModelMap getRecurringGiftList(HttpServletRequest request, SortInfo sort) {
        ...
        addListFieldsToMap(request, sectionFields, recurringGifts, list);
