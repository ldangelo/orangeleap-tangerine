...
/**
 * Clone of the FilterBasedLdapUserSearch. This class completely copies it, except
 * it knows how to split out a username in the user@site format and use the individual
 * components in the LDAP search.
 * NOTE: this class was cloned from FilterBasedLdapUserSearch (aka, copy-paste)
...
public class TangerineLdapUserSearch implements LdapUserSearch {
    ...
    private static final Log logger = LogFactory.getLog(TangerineLdapUserSearch.class);
     ...
     *
     * @throws org.springframework.security.userdetails.UsernameNotFoundException if no matching entry is found.
     */
    public DirContextOperations searchForUser(String username) {
        ...
        try {
            ...
            return template.searchForSingleEntry(searchBase, searchFilter, filterArgs);
