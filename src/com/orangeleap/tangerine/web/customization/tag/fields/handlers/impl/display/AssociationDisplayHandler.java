 ...
 * Time: 2:03:36 PM
 */
public class AssociationDisplayHandler extends AssociationHandler {

	public AssociationDisplayHandler(ApplicationContext applicationContext) {
		super(applicationContext);
	}

	protected void createLookupWrapperBegin(StringBuilder sb) {
        sb.append("<div class=\"lookupWrapper readOnly\">");
    }
}
