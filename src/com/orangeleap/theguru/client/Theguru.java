...
public interface Theguru {
    ...
    @WebResult(name = "GetSegmentationCountByTypeResponse", targetNamespace = "http://www.orangeleap.com/theguru/services/1.0", partName = "GetSegmentationCountByTypeResponse")
    @WebMethod(operationName = "GetSegmentationCountByType")
    public GetSegmentationCountByTypeResponse getSegmentationCountByType(
        @WebParam(partName = "GetSegmentationCountByTypeRequest", name = "GetSegmentationCountByTypeRequest", targetNamespace = "http://www.orangeleap.com/theguru/services/1.0")
        GetSegmentationCountByTypeRequest getSegmentationCountByTypeRequest
    );
