...
public class RecurringGiftServiceImplTest extends BaseTest {
    ...
    private List<RecurringGift> setupRecurringGifts() throws Exception {
        ...
        rGifts.add(new RecurringGift(1L, Commitment.STATUS_CANCELLED, sdf.parse("10/31/2009"), null, true));
        rGifts.add(new RecurringGift(2L, Commitment.STATUS_ACTIVE, sdf.parse("03/15/2009"), sdf.parse("04/15/2009"), true));
        rGifts.add(new RecurringGift(3L, Commitment.STATUS_IN_PROGRESS, sdf.parse("03/15/2009"), null, true));
        rGifts.add(new RecurringGift(4L, Commitment.STATUS_FULFILLED, sdf.parse("11/25/2009"), sdf.parse("11/30/2009"), true));
        rGifts.add(new RecurringGift(5L, Commitment.STATUS_EXPIRED, sdf.parse("03/15/2009"), sdf.parse("04/15/2009"), true));
        rGifts.add(new RecurringGift(6L, Commitment.STATUS_PENDING, sdf.parse("01/01/2009"), null, true));
        return rGifts;
    }
