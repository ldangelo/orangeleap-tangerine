		...
		<div class="content760 accountForm">
			...
			<table class="formTable">
				<tr>
					...
					<td><input size="30" class="loginField" type="password" name="currentPassword" id="currentPassword" /></td>
	    		</tr>
				<tr>
					<td style="text-align:right"><label for="j_password">Choose a <b>new password:</b></label></td>
					<td><input size="30" class="loginField" type="password" name="newPassword" id="newPassword" /></td>
	    		</tr>
				<tr>
					<td style="text-align:right"><label for="j_username">Confirm your <b>new password:</b></label></td>
					<td><input size="30" class="loginField" type="password" name="newPasswordConfirm" id="newPasswordConfirm" /></td>
	    		</tr>
    		</table>
