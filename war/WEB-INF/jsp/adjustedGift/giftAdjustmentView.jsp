		...
		<form:form method="post" commandName="${requestScope.commandObject}">
			...
			<div class="formButtonFooter constituentFormButtons">
				...
				<c:if test="${!requestScope.hideAdjustGiftButton}">
					<a class="newAccountButton" href="giftAdjustment.htm?giftId=${form.domainObject.originalGiftId}&constituentId=${constituent.id}"><spring:message code='enterNewAdjustment'/></a>
				</c:if>
			</div>
		</form:form>
		</body>
