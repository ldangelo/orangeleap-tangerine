...
<page:applyDecorator name="form">
	<spring:message code='viewBackground' var="titleText" scope="request" />
	...
	<html>
		...
		<body>
			<form:form method="post" commandName="${requestScope.commandObject}" cssClass="disableForm">
				...
				<tangerine:fields pageName="backgroundView"/>

				<div class="formButtonFooter constituentFormButtons">
					<input type="submit" value="<spring:message code='submit'/>" class="saveButton" />
					<c:if test="${pageAccess['/backgroundList.htm']!='DENIED'}">
        ...
        <script type="text/javascript">
            $(function() {
                $("#cancelButton").click(function() {
                    OrangeLeap.gotoUrl('backgroundList.htm?constituentId=${constituent.id}');
                });
            });
            var ButtonPanel = Ext.extend(Ext.Panel, {
                ...
                menu : {
                    items: [
                        { text: '<spring:message code='enterNew'/>', handler: function() { OrangeLeap.gotoUrl("background.htm?constituentId=${requestScope.constituent.id}"); } }
                    ]
                },
                split: false,
