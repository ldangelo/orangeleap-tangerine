		...
		<ul id="codeResultsUl" class="queryUl">
			<c:forEach items="${codes}" var="code">
				<li id="<c:out value='${code.value}'/>-li">
					<input type="radio" name="option" id="${code.value}" title="<spring:message code='clickToSelect'/>" value="<c:out value='${code.value}'/>" displayvalue="<c:out value='${code.description}'/>" />
