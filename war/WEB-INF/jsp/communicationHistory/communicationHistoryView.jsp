...
<tiles:insertDefinition name="base">
	<tiles:putAttribute name="browserTitle" value="View Communication History Entry" />
	<tiles:putAttribute name="primaryNav" value="People" />
	<tiles:putAttribute name="secondaryNav" value="Search" />
	<tiles:putAttribute name="sidebarNav" value="communicationHistoryView" />
	<tiles:putAttribute name="mainContent" type="string">
		<div class="content760 mainForm">
			...
			<form:form method="post" commandName="communicationHistory">
				...
				<div class="formButtonFooter personFormButtons"><input type="submit" value="<spring:message code='submitCommunicationHistory'/>" class="saveButton" /></div>
			</form:form>
		</div>
	</tiles:putAttribute>
