	...
	<tiles:putAttribute name="mainContent" type="string">
		...
		<div class="simplebox">
		 ...
		 <form id="form" method="post" action="customField.htm">
		   ...
		   <script>
		    function populateSectionFieldsForEntity() {
			    <%-- use json controller to populate section field dropdown for entity type   --%>
		    }
		   </script>
		   ...
		   <div id="selectEntityType">
  		      <h4>Entity Type</h4>
		      <select id="entityType" name="entityType" onchange="if (this.value == 'person') { $('#selectConstituentType').show(); } else { ('#selectConstituentType').hide();  }; populateSectionFieldsForEntity(); ">
		   ...
		   <div id="selectSectionField"  style="display:none">
			  <h4>Place in section field name:<h4>
		      <select id="sectionField" name="sectionField" >
		  	    <option value="" >Select...</option>
		      </select>
		   </div>
