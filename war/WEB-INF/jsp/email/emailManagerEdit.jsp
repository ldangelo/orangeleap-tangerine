...
<page:applyDecorator name="form">
	<spring:message code='editEmail' var="titleText" scope="request" />
	...
	<html>
		...
		<body>
			<form:form method="post" commandName="${requestScope.commandObject}">
				...
				<tangerine:fields pageName="emailManagerEdit"/>
    ...
    <page:param name="scripts">
        <script type="text/javascript">
            var ButtonPanel = Ext.extend(Ext.Panel, {
                ...
                menu : {
                    items: [
                        { text: '<spring:message code='enterNew'/>', handler: function() { OrangeLeap.gotoUrl("emailManager.htm?constituentId=${requestScope.constituent.id}"); } }
                    ]
                },
                split: false,
