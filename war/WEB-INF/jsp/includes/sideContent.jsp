					...
					<div class="navGroup">
			            ...
			            <span class="secondary ${requestScope.thisUrl eq '/gift.htm' ? 'active' : ''}">
							...
							<c:if test="${pageAccess['/giftList.htm']!='DENIED'}">
			            		<a class="${((requestScope.thisUrl eq '/gift.htm' && !requestScope.form.domainObject.new) || requestScope.thisUrl eq '/giftList.htm' || requestScope.thisUrl eq '/giftPaid.htm' || requestScope.thisUrl eq '/giftPosted.htm' || requestScope.thisUrl eq '/adjustedGift.htm' || requestScope.thisUrl eq '/adjustedGiftView.htm') ? 'active' : ''}" href="giftList.htm?constituentId=${requestScope.constituent.id}"><spring:message code="gifts"/></a>
							</c:if>
