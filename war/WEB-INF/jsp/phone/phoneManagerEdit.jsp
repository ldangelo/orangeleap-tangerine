...
<page:applyDecorator name="form">
	<spring:message code='editPhone' var="titleText" scope="request" />
	...
	<html>
		...
		<body>
			<form:form method="post" commandName="${requestScope.commandObject}">
				...
				<tangerine:fields pageName="phoneManagerEdit"/>
    ...
    <page:param name="scripts">
        <script type="text/javascript">
            var ButtonPanel = Ext.extend(Ext.Panel, {
                ...
                menu : {
                    items: [
                        { text: '<spring:message code='enterNew'/>', handler: function() { OrangeLeap.gotoUrl("phoneManager.htm?constituentId=${requestScope.constituent.id}"); } }
                    ]
                },
                split: false,
    ...
    </page:param></page:applyDecorator>
