               ...
               <br/>
                  ...
                  <div>
                    <form:form method="post" commandName="map" >
                        <h4>Edit Site Defaults</h4><br/>
                        <table class="customFields">
                        <c:forEach var="field" varStatus="status" items="${map}" >
                          <tr rowindex="${status.count}">
                            <td><input type="hidden" id="cfname-${status.count}-key" name="cfname[${status.count}]" size="32" value="<c:out value='${field.key}'/>" /><c:out value='${field.key}'/></td>
